...
src_prepare() {
	...
	rm -f "${WORKDIR}/patches/chromium-84-blink-disable-clang-format.patch"
	rm -f "${WORKDIR}/patches/chromium-88-CompositorFrameReporter-dcheck.patch"
	rm -f "${WORKDIR}/patches/chromium-88-ityp-include.patch"
	rm -f "${WORKDIR}/patches/chromium-89-stringstream.patch"
	rm -f "${WORKDIR}/patches/chromium-fix-char_traits.patch"
	rm -f "${WORKDIR}/patches/chromium-89-quiche-dcheck.patch"

	local PATCHES=(
		"${WORKDIR}/patches"
		"${FILESDIR}/chromium-89-ImageSkiaStorage-const.patch"
		"${FILESDIR}/chromium-89-FreezingVoteToken-include.patch"
		"${FILESDIR}/chromium-89-webui_config-include.patch"
		"${FILESDIR}/chromium-89-FramebufferCache-incomplete-type.patch"
		"${FILESDIR}/chromium-89-quiche-dcheck.patch"
		"${FILESDIR}/chromium-fix-char_traits-r1.patch"
