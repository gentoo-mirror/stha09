...
src_prepare() {
	...
	local UNUSED_PATCHES=(
		"chromium-92-DownloadShelfPageHandler-confusion.patch"
		"chromium-92-PowerModeVoter-include.patch"
		"chromium-92-BoxPreflightCheckApiCallFlow-ostream.patch"
	)
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-92-buffer_types-include.patch"
