...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-103-gcc-12-r1.patch"
		"${FILESDIR}/chromium-103-PageRange-include.patch"
		"${FILESDIR}/chromium-103-fenced_frame_utils-include.patch"
		"${FILESDIR}/chromium-103-cpuinfo-gnu-source.patch"
