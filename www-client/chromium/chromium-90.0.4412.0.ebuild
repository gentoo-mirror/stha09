...
src_prepare() {
	...
	local UNUSED_PATCHES=(
		...
		"chromium-90-dawn-BindInfo.patch"
	)
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-90-RenderingStageScheduler-include.patch"
		"${FILESDIR}/chromium-90-AXTreeSerializer-include.patch"
		"${FILESDIR}/chromium-90-skia-CropRect.patch"
		"${FILESDIR}/chromium-90-DelegatedInkTrailData-incomplete-type.patch"
		"${FILESDIR}/chromium-90-NameInfo-include.patch"
