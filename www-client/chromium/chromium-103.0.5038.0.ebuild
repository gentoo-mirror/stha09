...
src_prepare() {
	...
	local UNUSED_PATCHES=(
		"chromium-103-QueryProcessor-type.patch"
	)
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-103-WidgetEventHandler-include.patch"
		"${FILESDIR}/chromium-103-WebContentsViewDelegate-include.patch"
		"${FILESDIR}/chromium-103-regex_patterns-array.patch"
