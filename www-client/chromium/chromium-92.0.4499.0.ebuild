...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-92-string_piece-include.patch"
		"${FILESDIR}/chromium-92-InspectorIssue-incomplete-type.patch"
		"${FILESDIR}/chromium-92-LoadStreamTask-ostream.patch"
		"${FILESDIR}/chromium-92-v8-include.patch"
