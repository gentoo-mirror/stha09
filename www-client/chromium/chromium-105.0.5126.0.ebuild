...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-105-PdfViewWebPlugin-const.patch"
		"${FILESDIR}/chromium-105-PageTracker-include.patch"
		"${FILESDIR}/chromium-105-compiler.patch"
		"${FILESDIR}/chromium-105-FramebufferHelper-incomplete-type.patch"
		"${FILESDIR}/chromium-105-perfetto-include.patch"
...
chromium_configure() {
	...
	if use headless; then
		...
		myconf_gn+=" use_system_wayland_scanner=$(usex wayland true false)"
