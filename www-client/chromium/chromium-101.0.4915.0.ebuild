...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-101-MaglevPrintingVisitor-include.patch"
		"${FILESDIR}/chromium-101-BlockConstIterator-allocator.patch"
		"${FILESDIR}/chromium-101-CBC_CommonBitMatrix-include.patch"
