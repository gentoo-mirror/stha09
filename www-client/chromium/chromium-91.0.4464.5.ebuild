...
src_prepare() {
	...
	local UNUSED_PATCHES=(
		"chromium-91-ToV8Traits-fixes.patch"
		"chromium-91-EffectPaintPropertyNode-type-confusion.patch"
		"chromium-91-pcscan-type-confusion.patch"
	)
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-91-AdsPageLoadMetricsObserver-type-confusion.patch"
