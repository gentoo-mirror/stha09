...
src_prepare() {
	...
	local UNUSED_PATCHES=(
		"chromium-90-DelegatedInkTrailData-incomplete-type.patch"
		"chromium-90-NameInfo-include.patch"
		"chromium-90-RenderingStageScheduler-include.patch"
		"chromium-90-time-constexpr.patch"
		"chromium-90-AXTreeSerializer-include.patch"
		"chromium-90-skia-CropRect.patch"
	)
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-90-FrameToken-constexpr.patch"
		"${FILESDIR}/chromium-90-empty-map-crash.patch"
		"${FILESDIR}/chromium-90-WaylandEventWatcher-include.patch"
