...
src_prepare() {
	...
	local PATCHES=(
		"${WORKDIR}/patches"
		"${FILESDIR}/chromium-90-TokenizedOutput-include.patch"
		"${FILESDIR}/chromium-90-quantization_utils-include.patch"
		"${FILESDIR}/chromium-91-BufferConsumer-include.patch"
		"${FILESDIR}/chromium-91-angle-constexpr.patch"
