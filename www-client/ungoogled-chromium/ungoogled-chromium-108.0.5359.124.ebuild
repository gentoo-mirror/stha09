...
SRC_URI="https://commondatastorage.googleapis.com/chromium-browser-official/${P#ungoogled-}.tar.xz
	https://github.com/stha09/chromium-patches/releases/download/${PATCHSET_NAME}/${PATCHSET_NAME}.tar.xz
	https://github.com/ungoogled-software/ungoogled-chromium/archive/refs/tags/${PV}-1.tar.gz -> ${P}.tar.gz
	pgo? ( https://github.com/elkablo/chromium-profiler/releases/download/v0.2/chromium-profiler-0.2.tar )"

LICENSE="BSD"
SLOT="0/stable"
KEYWORDS="~amd64 ~arm64"
IUSE="+X component-build cups cpu_flags_arm_neon custom-cflags debug gtk4 headless kerberos libcxx lto +official pgo pic +proprietary-codecs pulseaudio qt5 screencast selinux +suid +system-av1 +system-ffmpeg +system-harfbuzz +system-icu +system-png vaapi wayland widevine"
REQUIRED_USE="
...
src_prepare() {
	...
	utils/prune_binaries.py "${S}" pruning.list || die

	# Apply ungoogled-chromium patchset
	utils/patches.py apply "${S}" patches || die
...
chromium_configure() {
	...
	# esdbuild is removed with ungoogled-chromium
...
chromium_profile() {
	...
	if ! "${EPYTHON}" ./chromium_profiler.py \
		...
		--chromedriver-executable "${S}/out/Release/chromedriver" \
